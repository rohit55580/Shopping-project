                    ...
                    <body>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div id="sidebar" class="span3">
                                    <div class="well well-small">
                                        <ul class="nav nav-list">
                                            <li><a href="three_column.jsp?type=T.V."><span class="icon-chevron-right"></span>Television</a></li>
                                            <li><a href="three_column.jsp?type=Refrigerators"><span class="icon-chevron-right"></span>Refrigerators</a></li>
                                            <li><a href="three_column.jsp?type=AC and Fan"><span class="icon-chevron-right"></span>Air Conditioners and Coolers</a></li>
                                            <li><a href="four_column.jsp?type=Washing Machines"><span class="icon-chevron-right"></span>Washing Machines</a></li>
                                            <li><a href="four_column.jsp?type=Computer and Peripherals"><span class="icon-chevron-right"></span>Computer and Peripherals</a></li>
                                            <li><a href="four_column.jsp?type=Laptops"><span class="icon-chevron-right"></span>Laptops</a></li>
                                            <li><a href="four_column.jsp?type=Mobiles"><span class="icon-chevron-right"></span>Mobiles</a></li>
                            ...
                            <footer class="footer">
                                <div class="row-fluid">
                                    ...
                                    <div class="span6">
                                        ...
                                        Terms and conditions are subject to the nature of the business which the
                                        individual seeks to run. Terms and conditions can fall under copyright and if
                                        these are reproduced by anyone else, then it is an infringement of copyright.
                        ...
                        <div class="copyright">
                            <div class="container">
                                ...
                                <span>Copyright &copy; 2022<br>E-commerce shopping site</span>
                            </div>
                        </div>
                        <a href="#" class="gotop"><i class="icon-double-angle-up"></i></a>
                        <!-- Placed at the end of the document so the pages load faster -->
